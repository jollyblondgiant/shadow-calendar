...
if((i < len)){
var k = (ks[i]);
var G__38341 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__38342 = (i + (1));
m = G__38341;
i = G__38342;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__38245 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__38245);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38247 = c;
var G__38247__$1 = (((G__38247 == null))?null:G__38247.prototype);
if((G__38247__$1 == null)){
return null;
} else {
return (G__38247__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38253 = c;
var G__38253__$1 = (((G__38253 == null))?null:G__38253.prototype);
if((G__38253__$1 == null)){
return null;
} else {
return (G__38253__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__38347__delegate = function (args){
var G__38260 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__38260) : reagent.impl.component.as_element.call(null,G__38260));
};
var G__38347 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38348__i = 0, G__38348__a = new Array(arguments.length -  0);
while (G__38348__i < G__38348__a.length) {G__38348__a[G__38348__i] = arguments[G__38348__i + 0]; ++G__38348__i;}
  args = new cljs.core.IndexedSeq(G__38348__a,0,null);
} 
return G__38347__delegate.call(this,args);};
G__38347.cljs$lang$maxFixedArity = 0;
G__38347.cljs$lang$applyTo = (function (arglist__38349){
var args = cljs.core.seq(arglist__38349);
return G__38347__delegate(args);
});
G__38347.cljs$core$IFn$_invoke$arity$variadic = G__38347__delegate;
return G__38347;
})()
;})(c,f,_,res))
:res);
...
var _STAR_current_component_STAR__orig_val__38263 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38264 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38264);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38263);
}});
...
var or__4061__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__38267_38352 = (c["cljsRatom"]);
if((G__38267_38352 == null)){
} else {
reagent.ratom.dispose_BANG_(G__38267_38352);
}
...
if(cljs.core.truth_((function (){var and__4050__auto__ = wrap;
...
var renders_38353 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_38354 = cljs.core.first(cljs.core.vals(renders_38353));
if((cljs.core.count(renders_38353) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_38353))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_38354)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_38354], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}


var render_fun = (function (){var or__4061__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
} else {
...
var render_fun__$1 = (function (){var or__4061__auto__ = render_fun;
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
} else {
...
var name = cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__4061__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
} else {
...
var name__$1 = (function (){var G__38268 = name;
switch (G__38268) {
case "":
...
var G__38287 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__38287);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__38296 = fiber;
var G__38296__$1 = (((G__38296 == null))?null:(G__38296["type"]));
if((G__38296__$1 == null)){
return null;
} else {
return (G__38296__$1["displayName"]);
}
})();
var parent = (function (){var G__38301 = fiber;
if((G__38301 == null)){
return null;
} else {
return (G__38301["return"]);
}
})();
var path = (function (){var G__38302 = parent;
var G__38302__$1 = (((G__38302 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__38302) : reagent.impl.component.fiber_component_path.call(null,G__38302)));
if((G__38302__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38302__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var G__38307 = c;
if((G__38307 == null)){
return null;
} else {
return (G__38307["_reactInternalFiber"]);
}
})();
...
var elem = (function (){var G__38308 = (function (){var or__4061__auto__ = (function (){var G__38310 = c;
if((G__38310 == null)){
return null;
} else {
return (G__38310["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
...
return (G__38308["_currentElement"]);
}
})();
var name = (function (){var G__38311 = elem;
var G__38311__$1 = (((G__38311 == null))?null:(G__38311["type"]));
if((G__38311__$1 == null)){
return null;
} else {
return (G__38311__$1["displayName"]);
}
})();
var path = (function (){var G__38312 = elem;
var G__38312__$1 = (((G__38312 == null))?null:(G__38312["_owner"]));
var G__38312__$2 = (((G__38312__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__38312__$1) : reagent.impl.component.component_path.call(null,G__38312__$1)));
if((G__38312__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38312__$2)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var n = (function (){var or__4061__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
} else {
var G__38317 = c;
var G__38317__$1 = (((G__38317 == null))?null:G__38317.constructor);
if((G__38317__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__38317__$1);
}
}
})();
