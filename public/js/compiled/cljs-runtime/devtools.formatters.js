...
var or__4061__auto__ = (devtools.util.in_node_context_QMARK_.cljs$core$IFn$_invoke$arity$0 ? devtools.util.in_node_context_QMARK_.cljs$core$IFn$_invoke$arity$0() : devtools.util.in_node_context_QMARK_.call(null));
if(or__4061__auto__){
return or__4061__auto__;
} else {
var and__4050__auto__ = goog.labs.userAgent.browser.isChrome();
...
(devtools.formatters.CLJSDevtoolsFormatter.cljs$lang$ctorPrWriter = (function (this__4304__auto__,writer__4305__auto__,opt__4306__auto__){
return cljs.core._write(writer__4305__auto__,"devtools.formatters/CLJSDevtoolsFormatter");
}));
...
var len__4665__auto___30834 = arguments.length;
var i__4666__auto___30835 = (0);
while(true){
if((i__4666__auto___30835 < len__4665__auto___30834)){
args__4671__auto__.push((arguments[i__4666__auto___30835]));

var G__30836 = (i__4666__auto___30835 + (1));
i__4666__auto___30835 = G__30836;
continue;
} else {
}
break;
...
return devtools.formatters.log_exception_if_avail.cljs$core$IFn$_invoke$arity$variadic(argseq__4672__auto__);
});
...
/** @this {Function} */
(devtools.formatters.log_exception_if_avail.cljs$lang$applyTo = (function (seq30821){
var self__4653__auto__ = this;
return self__4653__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq30821));
}));
...
while (G__30838__i < G__30838__a.length) {G__30838__a[G__30838__i] = arguments[G__30838__i + 0]; ++G__30838__i;}
  args = new cljs.core.IndexedSeq(G__30838__a,0,null);
} 
...
while (G__30841__i < G__30841__a.length) {G__30841__a[G__30841__i] = arguments[G__30841__i + 0]; ++G__30841__i;}
  args = new cljs.core.IndexedSeq(G__30841__a,0,null);
} 
...
var fexpr__30826_30843 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(monitor,sanitizer);
fexpr__30826_30843(api_call);
