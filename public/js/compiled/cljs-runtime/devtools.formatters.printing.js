...
var len__4665__auto___30443 = arguments.length;
var i__4666__auto___30444 = (0);
while(true){
if((i__4666__auto___30444 < len__4665__auto___30443)){
args__4671__auto__.push((arguments[i__4666__auto___30444]));

var G__30445 = (i__4666__auto___30444 + (1));
i__4666__auto___30444 = G__30445;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4672__auto__);
});
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30345){
var G__30346 = cljs.core.first(seq30345);
var seq30345__$1 = cljs.core.next(seq30345);
var G__30347 = cljs.core.first(seq30345__$1);
var seq30345__$2 = cljs.core.next(seq30345__$1);
var self__4652__auto__ = this;
return self__4652__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30346,G__30347,seq30345__$2);
}));
...
if(cljs.core.truth_((function (){var or__4061__auto__ = devtools.formatters.helpers.directly_printable_QMARK_(value);
if(or__4061__auto__){
...
(devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__4304__auto__,writer__4305__auto__,opt__4306__auto__){
return cljs.core._write(writer__4305__auto__,"devtools.formatters.printing/TemplateWriter");
}));
...
if(cljs.core.truth_(((cljs.core.not(devtools.formatters.printing.already_reference_QMARK_(group)))?(function (){var or__4061__auto__ = devtools.formatters.helpers.expandable_QMARK_(obj);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30398_SHARP_){
return (!((cljs.core.meta(p1__30398_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30406__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__4061__auto__ = (function (){try{if((!((obj == null)))){
...
}catch (e30410){var _e__27543__auto__ = e30410;
return false;
}})();
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
...
}catch (e30413){var _e__27543__auto__ = e30413;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30418 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30419 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30419);

try{var map__30420 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30420__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30418);
}});
...
var temp__5733__auto___30474 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___30474)){
var managed_print_level_30475 = temp__5733__auto___30474;
var _STAR_print_level_STAR__orig_val__30435_30476 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30436_30477 = managed_print_level_30475;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30436_30477);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__30426_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__30426_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30435_30476);
}} else {
job_fn();
}
