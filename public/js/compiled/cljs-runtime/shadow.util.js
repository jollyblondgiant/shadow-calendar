...
var len__4665__auto___35733 = arguments.length;
var i__4666__auto___35734 = (0);
while(true){
if((i__4666__auto___35734 < len__4665__auto___35733)){
args__4671__auto__.push((arguments[i__4666__auto___35734]));

var G__35735 = (i__4666__auto___35734 + (1));
i__4666__auto___35734 = G__35735;
continue;
} else {
}
break;
...
return shadow.util.go_BANG_.cljs$core$IFn$_invoke$arity$variadic(argseq__4672__auto__);
});
...
/** @this {Function} */
(shadow.util.go_BANG_.cljs$lang$applyTo = (function (seq35682){
var self__4653__auto__ = this;
return self__4653__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq35682));
}));
...
var len__4665__auto___35743 = arguments.length;
var i__4666__auto___35744 = (0);
while(true){
if((i__4666__auto___35744 < len__4665__auto___35743)){
args_arr__4686__auto__.push((arguments[i__4666__auto___35744]));

var G__35746 = (i__4666__auto___35744 + (1));
i__4666__auto___35744 = G__35746;
continue;
} else {
}
break;
...
var argseq__4687__auto__ = (new cljs.core.IndexedSeq(args_arr__4686__auto__.slice((6)),(0),null));
return shadow.util.log.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),(arguments[(3)]),(arguments[(4)]),(arguments[(5)]),argseq__4687__auto__);
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq35694){
...
var G__35697 = cljs.core.first(seq35694__$2);
var seq35694__$3 = cljs.core.next(seq35694__$2);
var G__35698 = cljs.core.first(seq35694__$3);
var seq35694__$4 = cljs.core.next(seq35694__$3);
var G__35699 = cljs.core.first(seq35694__$4);
var seq35694__$5 = cljs.core.next(seq35694__$4);
var G__35700 = cljs.core.first(seq35694__$5);
var seq35694__$6 = cljs.core.next(seq35694__$5);
var self__4652__auto__ = this;
return self__4652__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35695,G__35696,G__35697,G__35698,G__35699,G__35700,seq35694__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__35716){
var vec__35718 = p__35716;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35718,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35718,(1),null);
