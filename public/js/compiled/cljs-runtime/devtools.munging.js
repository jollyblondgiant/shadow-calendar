...
var o29569 = temp__5733__auto__;
var temp__5733__auto____$1 = (o29569["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o29570 = temp__5733__auto____$1;
return (o29570["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27504__auto__ = f;
return (o__27504__auto__["toString"]).call(o__27504__auto__);
} else {
return "";
}
}catch (e29574){var _ = e29574;
return "";
}});
...
try{var o__27504__auto___29962 = t;
(o__27504__auto___29962["cljs$lang$ctorPrWriter"]).call(o__27504__auto___29962,t,writer);
}catch (e29576){var __29963 = e29576;
}
...
var char_code = (function (){var o__27504__auto__ = (new String(char$));
return (o__27504__auto__["charCodeAt"]).call(o__27504__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27504__auto__ = String;
return (o__27504__auto__["fromCharCode"]).call(o__27504__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29613 = num_code;
switch (G__29613) {
case (1):
return (185);
...
var o__27504__auto__ = String;
return (o__27504__auto__["fromCharCode"]).call(o__27504__auto__,superscript_code);
});
/**
...
}catch (e29630){var _e__27543__auto__ = e29630;
return false;
}})())){
...
var vec__29631 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29631,(0),null);
...
var or__4061__auto__ = (function (){var temp__5733__auto__ = cljs.core.re_matches(/(.*)\$/,s);
if(cljs.core.truth_(temp__5733__auto__)){
...
if(cljs.core.truth_(temp__5733__auto__)){
var o29655 = temp__5733__auto__;
var temp__5733__auto____$1 = (o29655["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o29656 = temp__5733__auto____$1;
return (o29656["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4665__auto___29996 = arguments.length;
var i__4666__auto___29997 = (0);
while(true){
if((i__4666__auto___29997 < len__4665__auto___29996)){
args__4671__auto__.push((arguments[i__4666__auto___29997]));

var G__29998 = (i__4666__auto___29997 + (1));
i__4666__auto___29997 = G__29998;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4672__auto__);
});

(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29669){
var vec__29670 = p__29669;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29670,(0),null);
var effective_detector = (function (){var or__4061__auto__ = ns_detector;
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
} else {
...
var G__29999 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__30000 = cljs.core.butlast(remaining_tokens);
name_tokens = G__29999;
remaining_tokens = G__30000;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29667){
var G__29668 = cljs.core.first(seq29667);
var seq29667__$1 = cljs.core.next(seq29667);
var self__4652__auto__ = this;
return self__4652__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29668,seq29667__$1);
}));
...
var vec__29697 = cljs.core.split_with((function (p1__29695_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29695_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29697,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29697,(1),null);
...
var vec__29703 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29703,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29703,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__30005 = cljs.core.rest(remaining_tokens);
var G__30006 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__30005;
name_tokens = G__30006;
continue;
} else {
...
var vec__29710 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29710,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29710,(1),null);
var vec__29713 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29713,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29713,(1),null);
var vec__29716 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29716,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29716,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29716,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29716,(3),null);
...
var vec__29734 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29734,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29734,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29734,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29734,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29734,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29734,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__29740 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29740,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29740,(1),null);
var vec__29743 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29743,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29743,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__29746 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__29746) : devtools.munging.parse_fn_info_deep.call(null,G__29746));
})()));
}
} else {
return fn_info;
...
var G__30039 = (arity + (1));
var G__30040 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29751){
var vec__29752 = p__29751;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29752,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29752,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities(f,(function (){var or__4061__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
} else {
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29757_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__29757_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29758_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__29758_SHARP_);
}),sorted_infos);
...
var args__4671__auto__ = [];
var len__4665__auto___30045 = arguments.length;
var i__4666__auto___30046 = (0);
while(true){
if((i__4666__auto___30046 < len__4665__auto___30045)){
args__4671__auto__.push((arguments[i__4666__auto___30046]));

var G__30048 = (i__4666__auto___30046 + (1));
i__4666__auto___30046 = G__30048;
continue;
} else {
}
break;
...
var argseq__4672__auto__ = ((((1) < args__4671__auto__.length))?(new cljs.core.IndexedSeq(args__4671__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4672__auto__);
});

(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29761){
var vec__29776 = p__29761;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29776,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29759){
var G__29760 = cljs.core.first(seq29759);
var seq29759__$1 = cljs.core.next(seq29759);
var self__4652__auto__ = this;
return self__4652__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29760,seq29759__$1);
}));
...
return devtools.munging.args_lists_to_strings(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((function (){var or__4061__auto__ = devtools.munging.collect_fn_arities(f);
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
} else {
...
return [(cljs.core.truth_((function (){var and__4050__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),(((!(cljs.core.empty_QMARK_(protocol_name))))?[(cljs.core.truth_(include_protocol_ns_QMARK_)?".":null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null),(((!(cljs.core.empty_QMARK_(protocol_method))))?[(cljs.core.truth_((function (){var or__4061__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29809__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29809__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29809__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29809__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29810 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29810,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29810,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29810,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29810,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29810,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29810,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__4050__auto__ = protocol_ns;
if(cljs.core.truth_(and__4050__auto__)){
return cljs.core.not((function (){var and__4050__auto____$1 = silence_common_protocols_QMARK_;
...
return [(function (){var or__4061__auto__ = protocol_part;
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
} else {
return fn_part;
...
var o__27504__auto__ = f;
return (o__27504__auto__["getBasis"]).call(o__27504__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__4050__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__4050__auto__)){
...
}catch (e29821){var _e__27543__auto__ = e29821;
...
var G__30056 = (obj[cljs.core.first(path)]);
var G__30057 = cljs.core.rest(path);
obj = G__30056;
path = G__30057;
continue;
} else {
...
var partition_bits = (function (){var or__4061__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
} else {
return (0);
...
var _STAR_ = (function (accum,p__29898){
var vec__29901 = p__29898;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29901,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29901,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29911){
var vec__29926 = p__29911;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29926,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29926,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29926,(2),null);
...
var post_process = (function (p__29936){
var vec__29937 = p__29936;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29937,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29937,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29932_SHARP_){
return (obj[cljs.core.first(p1__29932_SHARP_)]);
}),sorted_matches);
