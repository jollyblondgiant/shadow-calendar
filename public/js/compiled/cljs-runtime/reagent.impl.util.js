...
var vec__37856 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var start = first__37858;
var parts = seq__37857__$1;
...
var n = (function (){var or__4061__auto__ = ((cljs.core.fn_QMARK_(f))?(function (){var or__4061__auto__ = (f["displayName"]);
...
var or__4061__auto____$1 = (((((!((f == null))))?(((((f.cljs$lang$protocol_mask$partition1$ & (4096))) || ((cljs.core.PROTOCOL_SENTINEL === f.cljs$core$INamed$))))?true:false):false))?cljs.core.name(f):false);
...
var self__ = this;
var self__ = this;
var G__37879 = (arguments.length - (1));
switch (G__37879) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args37878){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args37878)));
}));
...
(reagent.impl.util.PartialFn.cljs$lang$ctorPrWriter = (function (this__4304__auto__,writer__4305__auto__,opt__4306__auto__){
return cljs.core._write(writer__4305__auto__,"reagent.impl.util/PartialFn");
}));
...
var _STAR_always_update_STAR__orig_val__37925 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__37926 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__37926);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__37925);
}} else {
