...
var reader = (function (){var or__4061__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__4061__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
} else {
return (128);
...
var G__27123 = cljs.core.PersistentArrayMap.EMPTY;
var G__27124 = native_stack_trace;
var G__27125 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__27126 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__27123,G__27124,G__27125,G__27126) : cljs.stacktrace.parse_stacktrace.call(null,G__27123,G__27124,G__27125,G__27126));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27137__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27137__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27137__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e27135){var _e = e27135;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___27189 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___27189)){
var seen_errors_27190 = temp__5733__auto___27189;
if(cljs.core.truth_(seen_errors_27190.has(self))){
} else {
seen_errors_27190.add(self);

var temp__5735__auto___27191 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___27191)){
var sense_27194 = temp__5735__auto___27191;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_27194)].join(''));
} else {
}
}
} else {
