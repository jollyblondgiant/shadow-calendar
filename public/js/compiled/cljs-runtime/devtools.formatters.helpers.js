...
var G__30041 = devtools.prefs.pref(v);
v = G__30041;
continue;
} else {
return v;
...
var or__4061__auto__ = (function (){try{if((!((value == null)))){
...
}catch (e29970){var _e__27543__auto__ = e29970;
return false;
}})();
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
} else {
var or__4061__auto____$1 = (function (){try{if((!((value == null)))){
...
}catch (e29975){var _e__27543__auto__ = e29975;
return false;
}})();
...
var and__4050__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__4050__auto__)){
...
var or__4061__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
} else {
...
var and__4050__auto__ = (function (){var or__4061__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_(value);
if(cljs.core.truth_(or__4061__auto__)){
return or__4061__auto__;
} else {
...
var vec__30002 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30002,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30002,(1),null);
...
var and__4050__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(and__4050__auto__)){
...
return cljs.core.some((function (p1__30030_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__30030_SHARP_);
}),template);
});
