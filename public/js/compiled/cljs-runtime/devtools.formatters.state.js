...
var len__4665__auto___30273 = arguments.length;
var i__4666__auto___30274 = (0);
while(true){
if((i__4666__auto___30274 < len__4665__auto___30273)){
args__4671__auto__.push((arguments[i__4666__auto___30274]));

var G__30275 = (i__4666__auto___30274 + (1));
i__4666__auto___30274 = G__30275;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4672__auto__);
});
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq30200){
var G__30201 = cljs.core.first(seq30200);
var seq30200__$1 = cljs.core.next(seq30200);
var self__4652__auto__ = this;
return self__4652__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30201,seq30200__$1);
}));
...
return cljs.core.some((function (p1__30245_SHARP_){
return (p1__30245_SHARP_ === object);
}),history);
});
